  ...
  return (
    ...
    >
      ...
      <path
        ...
        fill="none"
      />
      <circle cx="100" cy="28" r="18" className="fill-emerald-500/20 stroke-emerald-400/50" strokeWidth="2" />
      <path
      ...
      <div className="mx-auto max-w-7xl px-4 pb-16 pt-8 sm:px-6 md:px-8 md:pb-20 md:pt-10">
          ...
          {filtersOpen && (
            <>
              ...
              <motion.div
                ...
                className="fixed inset-x-0 bottom-0 z-[101] max-h-[88vh] overflow-y-auto rounded-t-2xl border border-slate-200/60 bg-white/95 p-4 pb-[max(1rem,env(safe-area-inset-bottom))] shadow-2xl backdrop-blur-xl dark:border-white/10 dark:bg-slate-950/90 md:hidden"
              >
        ...
        {loading ? (
          ...
          <div className="glass-card rounded-2xl py-16 text-center">
            <p className="mb-4 text-lg text-slate-600 dark:text-slate-400">{loadError}</p>
            <Button
          ...
          <div className="glass-card rounded-2xl border border-dashed border-slate-300/80 px-4 py-16 text-center dark:border-white/15">
            ...
            <p className="mb-2 text-xl font-semibold text-slate-900 dark:text-white">
              {listings.length === 0 ? t("noListings") : t("emptySearchTitle")}
            </p>
