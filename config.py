...
# Data files
RAW_DATA_FILE = os.path.join(BASE_DIR, 'iqcars60000data.xlsx')
CLEANED_DATA_FILE = os.path.join(BASE_DIR, 'cleaned_car_data.csv')
...
DAILY_UPDATE_TIME = "02:00"  # 2 AM daily
DAILY_UPDATE_MAX_LISTINGS = 500
DAILY_UPDATE_MODE = "incremental"  # incremental or recent
AUTO_COMMIT_TO_GITHUB = True  # Automatically commit and push updates to GitHub
