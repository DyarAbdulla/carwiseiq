...
plt.close()
print("  [OK] Saved: os.path.join(VISUALIZATIONS_DIR, '1_price_distribution.png")
...
plt.close()
print("  [OK] Saved: os.path.join(VISUALIZATIONS_DIR, '2_price_vs_year.png")
...
if 'make' in df.columns:
    ...
    plt.close()
    print("  [OK] Saved: os.path.join(VISUALIZATIONS_DIR, '3_price_by_make.png")
...
if 'fuel_type' in df.columns:
    ...
    plt.close()
    print("  [OK] Saved: os.path.join(VISUALIZATIONS_DIR, '4_price_by_fuel_type.png")
...
if 'condition' in df.columns:
    ...
    plt.close()
    print("  [OK] Saved: os.path.join(VISUALIZATIONS_DIR, '5_price_by_condition.png")
...
if 'mileage' in df.columns and 'year' in df.columns:
    ...
    plt.close()
    print("  [OK] Saved: os.path.join(VISUALIZATIONS_DIR, '6_mileage_vs_price.png")
...
plt.close()
print("  [OK] Saved: os.path.join(VISUALIZATIONS_DIR, '7_correlation_heatmap.png")
...
if 'location' in df.columns:
    ...
    plt.close()
    print("  [OK] Saved: os.path.join(VISUALIZATIONS_DIR, '8_price_by_location.png")
...
if 'engine_size' in df.columns:
    ...
    if len(engine_df) > 0:
        ...
        try:
            ...
            plt.close()
            print("  [OK] Saved: os.path.join(VISUALIZATIONS_DIR, '9_engine_size_vs_price.png")
            ...
            plt.savefig('os.path.join(VISUALIZATIONS_DIR, '9_engine_size_vs_price.png', dpi=300, bbox_inches='tight')
            plt.close()
            print("  [OK] Saved: os.path.join(VISUALIZATIONS_DIR, '9_engine_size_vs_price.png (scatter plot)")
...
print("  [OK] Saved: os.path.join(VISUALIZATIONS_DIR, '10_interactive_dashboard.html")
...
print(f"\n[OK] Statistical summary report saved to: os.path.join(VISUALIZATIONS_DIR, 'statistical_summary_report.txt")
...
if all(col in df.columns for col in ['year', 'mileage', 'price']):
    ...
    print("  [OK] Saved: os.path.join(VISUALIZATIONS_DIR, '11_3d_scatter.html")
...
if 'year' in df.columns and 'price' in df.columns:
    ...
    print("  [OK] Saved: os.path.join(VISUALIZATIONS_DIR, '12_animated_decades.html")
    print("  [OK] Saved: os.path.join(VISUALIZATIONS_DIR, '12_animated_trends.html")
...
if 'location' in df.columns:
    ...
    print("  [OK] Saved: os.path.join(VISUALIZATIONS_DIR, '13_geographic_heatmap.html")
...
if 'price' in numeric_df.columns:
    ...
    print("  [OK] Saved: os.path.join(VISUALIZATIONS_DIR, '14_feature_importance_waterfall.html")
...
print("  [OK] Saved: os.path.join(VISUALIZATIONS_DIR, '15_gauge_r2.html")
print("  [OK] Saved: os.path.join(VISUALIZATIONS_DIR, '15_gauge_mape.html")
...
print("=" * 80)
print(f"\nAll visualizations saved to 'os.path.join(VISUALIZATIONS_DIR, '' folder:")
