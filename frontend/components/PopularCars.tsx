...
export function PopularCars() {
  ...
  return (
    <section className="w-full min-w-0 py-8 sm:py-12" aria-labelledby="popular-cars-title">
      <div className="container mx-auto min-w-0 max-w-6xl px-3 sm:px-6">
        ...
        <div
          ...
          aria-label={t("title")}
          tabIndex={0}
          className="brand-logo-strip min-w-0 w-full max-w-full overflow-x-auto overflow-y-hidden pb-2 touch-pan-x overscroll-x-contain outline-none focus-visible:ring-2 focus-visible:ring-purple-500/40 rounded-lg -mx-1 px-1"
          style={{ WebkitOverflowScrolling: "touch" }}
        >
          <div className="flex w-max gap-4 py-0.5">
