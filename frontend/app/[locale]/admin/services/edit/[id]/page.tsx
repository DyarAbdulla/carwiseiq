...
export default function EditServicePage() {
  ...
  const loadService = async () => {
    try {
      const service = await apiClient.adminGetService(serviceId)
      setFormData({
        ...
        icon: service.icon || 'fuel-pump',
        icon_type: service.icon_type || 'library',
        is_all_iraq: service.is_all_iraq || false,
        locations: service.locations || [],
        status: service.status || 'active',
        display_order: service.display_order || 50,
        contact_phone: service.contact_phone || '',
        contact_email: service.contact_email || '',
        service_url: service.service_url || '',
        is_featured: service.is_featured || false,
        provider_name: service.provider_name || '',
        provider_logo: service.provider_logo || '',
        provider_phone: service.provider_phone || '',
        provider_email: service.provider_email || '',
        provider_website: service.provider_website || '',
        provider_address: service.provider_address || '',
        provider_whatsapp: service.provider_whatsapp || '',
        map_latitude: service.map_latitude?.toString() || '',
        map_longitude: service.map_longitude?.toString() || '',
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await apiClient.adminUpdateService(serviceId, submitData)
      toast({
        title: 'Success',
    ...
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-gray-400 mt-2">Update service information</p>
        </div>
      </div>
